...
BIS_WL_initModule setVariable ["BIS_WL_startCP", 2000]; // Correct place to change starting CP, defualt value 1000
...
BIS_WL_initModule setVariable ["BIS_WL_fastTravelCostContested", 1500]; //Cost of fast travel to contested sector
...
BIS_WL_initModule setVariable ["BIS_WL_baseValue", 100]; //this changes money from main base ie starter CP/Min, default value 10
...
BIS_WL_initModule setVariable ["BIS_WL_scanCooldown", 180];
