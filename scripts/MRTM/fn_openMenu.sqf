...
((findDisplay 8000) displayCtrl 8001) ctrlSetStructuredText parseText format ["<a href='https://discord.gg/grmzsZE4ua'>%1</a> <t size='1' valign='middle' align='right'>%2</t></t>", "Join the discord" splitString " " joinString toString [160], (name player)];
{
...
((findDisplay 8000) displayCtrl 8030) ctrlSetStructuredText parseText format ["<t size='1'><t size='1' valign='middle' align='left'>Kills: %1</t> <t size='1' valign='middle' align='right'>K/D:%2</t></t>", _kills, _kd];
