...
(_display displayCtrl 8030) ctrlSetStructuredText parseText format ["<t size='%3'><t size='%3' valign='middle' align='left'>Kills: %1</t> <t size='%3' valign='middle' align='right'>K/D: %2</t></t>", _kills, _kd, 0.8 call BIS_fnc_WL2_sub_purchaseMenuGetUIScale];
