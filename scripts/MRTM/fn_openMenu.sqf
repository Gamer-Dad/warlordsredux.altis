...
((findDisplay 8000) displayCtrl 1143) ctrlSetStructuredText parseText format ["<a href='https://discord.gg/grmzsZE4ua'>%1</a>", "Join the discord" splitString " " joinString toString [160]];
