...
if ((getPlayerUID _unit) in (player getVariable ["MRTM_invitesOut", []])) exitWith {"Img\green_arrow_ca.paa"};

if ((getPlayerUID _unit) in (player getVariable ["MRTM_invitesIn", []])) exitWith {"Img\red_arrow_ca.paa"};
