...
((findDisplay 6000) displayCtrl 6102) ctrlSetStructuredText composeText [
	...
	"-Enemy detection range increased to 200m.", lineBreak,
	"-Futura kill rewrad fixed.", lineBreak,
	"-Asset ordering code is faster.", lineBreak,
	"-AAF bypassing APS is fixed.", lineBreak,
	"-Debug messages removed.", lineBreak,
	"-Capturing values and other info added to new info tab.", lineBreak,
	"-Settings ui code improved.", lineBreak,
	"-General code clean up.", lineBreak,
	"-Opfor camo tent fixed.", lineBreak,
	"FPS drop fixed.", lineBreak,
	"-Autonomous UAV option added.", lineBreak,
