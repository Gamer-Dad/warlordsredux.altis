class CfgWarlordSectors {
    connections[] = {
        ...
        {"SkoposBase", "CapeMakrinos"},
        {"SkoposBase", "SkoposCastleRuins"},
        {"SkoposBase", "Ekali"},
        {"AACAirfield", "Poliakko"},
        {"AACAirfield", "Makrynisi"},
        {"SagonisiBase", "Katalaki"},
        {"SagonisiBase", "Poliakko"},
        {"SagonisiBase", "Makrynisi"},
        {"SagonisiBase", "Faronaki"},
        {"SagonisiBase", "Pyrgos"},
        {"Poliakko", "Katalaki"},
        {"Poliakko", "Alikampos"},
        {"Neochori", "Katalaki"},
        ...
        {"Selekano", "SelakanoOutpost"},
        {"Feres", "Panagia"},
        {"Feres", "SelekanoAirbase"},
        {"Feres", "AktinarkiRuins"},
        {"Feres", "TheMaziBouys"},
        ...
        {"GhostHotel", "FriniWoodlands"},
        {"GhostHotel", "TheaterRuins"},
        {"NidasosBase", "SofiaPowerPlant"},
        {"NidasosBase", "Sofia"},
        {"NidasosBase", "Sideras"},
        {"SofiaPowerPlant", "Sofia"},
        {"SofiaPowerPlant", "HillsideChapel"},
        {"Sofia", "GatoliaSolar"},
        {"Sofia", "Molos"},
        {"Sofia", "Sideras"},
        {"GatoliaSolar", "Molos"},
        ...
        {"NifiSolar", "Nifi"},
        {"NifiSolar", "LimniSwamp"},
        {"SaltFlats", "HillsideChapel"},
        {"SaltFlats", "AlmyraOutskirts"},
        {"Topolia", "MagosFactory"},
        ...
        {"LimniSwamp", "CapeKategidis"},
        {"DidymosTurbines", "Thequarry"},
        {"Livadi", "SelakanoOutpost"},
        {"FeresHelipadHill", "TheMaziBouys"}
    };
    ...
    class FeresHelipadHill {
        name = "Feres Helipad Hill";
        disableHome = 1;
        services[] = {"H"};
