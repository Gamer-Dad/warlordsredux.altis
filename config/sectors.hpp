class CfgWarlordSectors {
    ...
    class Kalochori {
        area[] = {250, 225, 147.52, 0};
        location[] = {21380.6, 16355.9, 0};
        name = "Kalochori";
    };
