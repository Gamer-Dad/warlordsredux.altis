	...
	class A3ReduxAll
	{
		class WEST
		{
			...
			class Gear
			{
				...
				class Box_NATO_AmmoVeh_F					{cost = 400;	requirements[]={};	};	// "Vehicle Ammo [NATO]"
			...
			class Defences
			{
				...
				class B_GMG_01_A_F							{cost = 500;	requirements[]={};	};	// "Mk30 GMG Auto Turret"
		...
		class EAST
		{
			...
			class Gear
			{
				...
				class Box_East_AmmoVeh_F					{cost = 400;	requirements[]={};	};	// "Vehicle Ammo [CSAT]"
			...
			class Defences
			{
				...
				class O_GMG_01_A_F							{cost = 500;	requirements[]={};	};	// "Mk30 GMG Auto Turret"
