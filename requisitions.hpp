	...
	class A3ReduxAll
	{
		class WEST
		{
			...
			class Defences
			{
				...
				class Land_Communication_F					{cost = 1500;	requirements[]={};	offset[]={0, 6, 0};};	// "Device (Stationary)" 
		...
		class EAST
		{
			...
			{	  
				...
				class I_Plane_Fighter_03_dynamicLoadout_F	{cost = 15000;	requirements[]={"A"};	};  // "A-143 Buzzard"
				...
				class O_Plane_Fighter_02_Stealth_F			{cost = 28000;	requirements[]={"A"};	};	// "To-201 Shikra (Stealth)"
			};
			class Naval
			{
				class C_Scooter_Transport_01_F				{cost = 50;		requirements[]={"W"};	};	// "Water scooter"
