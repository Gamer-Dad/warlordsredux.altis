	...
	class A3ReduxAll
	{
		class WEST
		{
			...
			class Defences
			{
				...
				class B_HMG_01_F							{cost = 350;	requirements[]={};	};	// "Mk30 HMG .50"  
				class B_HMG_01_high_F						{cost = 400;	requirements[]={};	};	// "Mk30 HMG .50 (Raised)" 
				class B_GMG_01_F							{cost = 350;	requirements[]={};	};	// "Mk32 GMG 20mm"  
				class B_GMG_01_high_F						{cost = 500;	requirements[]={};	};	// "Mk32 GMG 20mm (Raised)"				
				class B_HMG_01_A_F							{cost = 800;	requirements[]={};	};	// "Mk30 HMG Auto Turret"
				class B_GMG_01_A_F							{cost = 1000;	requirements[]={};	};	// "Mk30 GMG Auto Turret"
		...
		class EAST
		{
			...
			class Vehicles
			{
				...
				class O_G_Offroad_01_armed_F				{cost = 200;	requirements[]={};	};	// "Offroad (HMG)"
				class O_LSV_02_AT_F							{cost = 1500;	requirements[]={};	};	// "Qilin (AT)"
				...
				class O_APC_Tracked_02_cannon_F				{cost = 3700;	requirements[]={};	};	// "BTR-K Kamysh"
				...
				class I_Truck_02_MRL_F						{cost = 25000;	requirements[]={};	};	// "Zamak MRL"  
			};
			class Aircraft
			{	  
				class O_Heli_Light_02_unarmed_F				{cost = 550;	requirements[]={"H"};	};	// "PO-30 Orca (Unarmed)"  
				class O_Heli_Transport_04_F					{cost = 600;	requirements[]={"H"};	};	// "Mi-290 Taru"  
				...
				class O_T_UAV_04_CAS_F						{cost = 9500;	requirements[]={"A"};	};	// "KH-3A Fenghuang"
			...
			class Gear
			{
				...
				class Box_East_AmmoOrd_F					{cost = 300;	requirements[]={};	};	// "Explosives [CSAT]"
			...
			class Defences
			{
				...
				class Land_IRMaskingCover_01_F				{cost = 500;	requirements[]={};	offset[]={0, 8, 0};};	// "IR Masking Tent (Large)" 
				class O_HMG_01_F							{cost = 350;	requirements[]={};	};	// "Mk30 HMG .50"  
				class O_HMG_01_high_F						{cost = 400;	requirements[]={};	};	// "Mk30 HMG .50 (Raised)"
				class O_GMG_01_F							{cost = 350;	requirements[]={};	};	// "Mk32 GMG 20 mm"
				class O_GMG_01_high_F						{cost = 400;	requirements[]={};	};	// "Mk32 GMG 20 mm (Raised)"
				...
				class O_HMG_01_A_F							{cost = 800;	requirements[]={};	};	// "Mk30 HMG Auto Turret"
				class O_GMG_01_A_F							{cost = 1000;	requirements[]={};	};	// "Mk30 GMG Auto Turret"
				class O_Mortar_01_F							{cost = 6500;	requirements[]={};	};	// "Mortar"  
				...
				class O_UGV_01_rcws_F						{cost = 1000;	requirements[]={};	};	// "UGAV rcws"  
				...
				class B_AAA_System_01_F 					{cost = 5000;	requirements[]={};	offset[]={0, 5.3, 0};};	// "Praetorian 1C";  
				class B_SAM_System_01_F						{cost = 15000;	requirements[]={};	offset[]={0, 5.3, 0};};	// "Mk49 Spartan";  
				class O_SAM_System_04_F						{cost = 12000;	requirements[]={};	offset[]={0, 5.3, 0};};	// "S-750 Rhea"  
				class B_SAM_System_02_F						{cost = 20000;	requirements[]={};	offset[]={0, 5.3, 0};};	// "Mk21 Centurion";  
				class B_Ship_MRLS_01_F						{cost = 40000;	requirements[]={};	offset[]={0, 5.3, 0};};	// "Mk41 VLS";  
			};
		};
