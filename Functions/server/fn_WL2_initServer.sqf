...
addMissionEventHandler ["EntityCreated", {
    ...
    if (typeOf _entity == "I_Truck_02_MRL_F") then { //Zamak MLRS
        _entity setObjectTexture [0, "A3\armor_f_gamma\mbt_01\data\mbt_01_scorcher_hexarid_co.paa"]; //Zamak cabin
        //_entity setObjectTexture [1, "A3\armor_f_gamma\mbt_02\data\mbt_02_body_co.paa"]; //Does nothing but keep for reminder
        _entity setObjectTexture [2, "A3\armor_f_gamma\mbt_01\data\mbt_01_scorcher_hexarid_co.paa"]; //Zamak Bed&Launcher                
    };               
