...
if (!isNull _sector) then {
	...
	if (_sector in [((profileNamespace getVariable "BIS_WL_lastBases") # 0), ((profileNamespace getVariable "BIS_WL_lastBases") # 1)]) then {
	...
	if (_prevSector in [((profileNamespace getVariable "BIS_WL_lastBases") # 0), ((profileNamespace getVariable "BIS_WL_lastBases") # 1)]) then {
