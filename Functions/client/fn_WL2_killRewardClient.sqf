...
((uiNamespace getVariable ["activeControls", []]) pushBack (uiNamespace getVariable "control"));
uiNamespace setVariable ["activeControls", (uiNamespace getVariable ["activeControls", []])];
