...
_ctrlBackgroundTimer ctrlSetPosition [_displayX + (_blockW * 80), _displayY + (_blockH * - 29), _blockW * 40, _blockH * 16];

private _ctrlTimer = findDisplay 46 ctrlCreate ["RscStructuredText", 45671];
_ctrlTimer ctrlSetPosition [_displayX + (_blockW * 100), _displayY + (_blockH * - 29), _blockW * 90, _blockH * 16];
