...
private _minesBlacklist = ["APERSMineDispenser_Mag", "APERSBoundingMine_Range_Mag", "APERSMine_Range_Mag", "APERSTripMine_Wire_Mag", "ClaymoreDirectionalMine_Remote_Mag", "DemoCharge_Remote_Mag", "SatchelCharge_Remote_Mag", "IEDUrbanBig_Remote_Mag", "IEDLandBig_Remote_Mag", "IEDUrbanSmall_Remote_Mag", "IEDLandSmall_Remote_Mag", "TrainingMine_Mag"];
...
BIS_fnc_arsenal_data set [2, ((BIS_fnc_arsenal_data select 2) select {!(_x in (getArray (missionConfigFile >> "arsenalConfig" >> _playerSide >> "handgunsBlacklist")))})];
