...
BIS_fnc_arsenal_data set [3, (getArray (missionConfigFile >> "arsenalConfig" >> str BIS_WL_playerSide >> "Uniforms"))];
BIS_fnc_arsenal_data set [4, (getArray (missionConfigFile >> "arsenalConfig" >> str BIS_WL_playerSide >> "Vests"))];
BIS_fnc_arsenal_data set [5, (getArray (missionConfigFile >> "arsenalConfig" >> str BIS_WL_playerSide >> "Backpacks"))];
BIS_fnc_arsenal_data set [6, (getArray (missionConfigFile >> "arsenalConfig" >> str BIS_WL_playerSide >> "Helmets"))];
BIS_fnc_arsenal_data set [11, (getArray (missionConfigFile >> "arsenalConfig" >> str BIS_WL_playerSide >> "Terminals"))];
