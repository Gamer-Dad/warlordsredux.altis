...
private _linesix = "Season: Hunt for Red October, Low cost Naval units, High cost AT/helis/Armor";
...
"Welcome to Warlords Redux 2.0! Please read below..." hintC [_lineone, _linetwo, _linethree, _linefour, _linefive, _linesix]; 
